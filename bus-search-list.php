...
<head>
    ...
    <!-- Title -->
    <title>Bus search result - Immitours </title>
    <!-- Bootstrap css -->
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item">
                                                    <a href="bus-search-list.html" class="nav-link active">Bus</a>
                                                </li>
                                                <li class="nav-item">
                                ...
                                <div class="flight_search_item_wrappper">
                                    <div class="flight_search_items">
                                        ...
                                        <div class="flight_search_right">
                                            ...
                                            <a href="#!" class="btn btn_theme btn_sm"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">Book now</a>
                            ...
                            <div class="col-lg-6">
                                <div class="bus_seat_right_side">
                                  ...
                                  <div class="bus_ticket_continue">
                                     <a href="bus-booking.html" class="btn btn_theme btn_sm">Continue</a>
                                  </div>
                                </div>
                            </div>
                        </div>
