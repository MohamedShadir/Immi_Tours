...
<head>
    ...
    <!-- Title -->
    <title>Tour booking - Immitours </title>
    <!-- Bootstrap css -->
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="tour-booking.html" class="nav-link active">Tour booking</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="dashboard_sidebar">
                        ...
                        <div class="dashboard_menu_area">
                            <ul>
                                    ...
                                    <div class="booing_sidebar_dashboard" id="show_dropdown_item"
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="flight-booking.html"><i class="fas fa-paper-plane"></i>Flight
                                                    booking</a></li>
                                            <li>
                                                <a href="tour-booking.html" class="active">
                                ...
                                <li><a href="my-profile.html"><i class="fas fa-user-circle"></i>My
                                        profile</a></li>
